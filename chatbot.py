...
def main():
    ...
    if choice == "Home":
        ...
        if not os.path.exists(r"chat_log.csv"):
            with open(r"chat_log.csv", 'w', newline='', encoding='utf-8') as csvfile:
        ...
        if user_input:
            ...
            with open(r"chat_log.csv", 'a', newline='', encoding='utf-8') as csvfile:
                csv_writer = csv.writer(csvfile)
    ...
    # Conversation History Menu
        ...
        with open(r"chat_log.csv", 'r', encoding='utf-8') as csvfile:
